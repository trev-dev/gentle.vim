...
let s:p.insert.left = [[["#ffff87", 228], ["#6a6b3f", 242]], [["#282828", 235], ["#ffff00", 11]]]
let s:p.insert.middle = [[["#6a6b3f", 242], ["#ffff87", 228]]]
let s:p.insert.right = [[["#ffff87", 228], ["#6a6b3f", 242]], [["#282828", 235], ["#ffff00", 11]]]
...
let g:lightline#colorscheme#gentleplus#palette = lightline#colorscheme#flatten(s:p)
